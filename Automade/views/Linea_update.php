            ...
            <?=form_open(base_url()."Linea/Lineaprocess_update/id/".$uri_segment_index)?>
            <table>
            <tr>
...
<tr>
    ...
    <td><?php echo form_dropdown('pedido_idpedido', $options_2['pedido_idpedido'], $data->pedido_idpedido); ?></td>
</tr>
<tr>
...
<tr>
    ...
    <td><?php echo form_dropdown('producto_idproducto', $options_6['producto_idproducto'], $data->producto_idproducto); ?></td>
</tr>
