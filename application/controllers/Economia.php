...
class Economia extends CI_Controller {
	...
	$this->load->library('pagination'); //Cargamos la librería de paginación
        ...
        $config['base_url'] = site_url('/Economia/index');
        $config['total_rows'] = $this->Tienda_model->filas_eco();//calcula el número de filas 
        ...
        $libros = $this->Tienda_model->libros_economia($config['per_page'], $desde);
